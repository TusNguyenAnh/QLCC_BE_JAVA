package com.mbs.qlcc.usecases.response.Complex;
...
public class ComplexResponse {
    ...
    public ComplexResponse(String id, String complexName, String address, int totalBuilding, int totalApartment, String nameContact, String phoneContact, String emailContact, String description, String financialModel) {
        this.id = id;
